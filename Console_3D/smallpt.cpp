...
struct Vec
{
	...
	INLINE double operator%(const Vec& b) const
	{ // dot
...
int main(int argc, char *argv[])
{
	...
	const int samps = argc == 2 ? atoi(argv[1]) / 4 : 960; // # samples
...
#pragma omp parallel for schedule(dynamic, 1)       // OpenMP
	...
	FILE *f = fopen("image.bmp", "wb"); // Write image to PPM file.
	const unsigned char hdr[] = { 0x42, 0x4D, 0x38, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x36, 0x00, 0x00, 0x00, 0x28, 0x00, 0x00, 0x00 };
	const unsigned char hdr2[] = { 0x01, 0x00, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x03, 0x00, 0x12, 0x0B, 0x00, 0x00, 0x12, 0x0B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
